...
class ProgramNRF24Lx1Subtarget(Elaboratable):
    def __init__(self, controller, prog, dut_prog, reset, dut_reset):
    ...
    def elaborate(self, platform):
        ...
        m.submodules.prog_buffer  = prog_buffer  = io.Buffer("o", self.prog)
        m.submodules.reset_buffer = reset_buffer = io.Buffer("o", self.reset)
        m.d.comb += [
